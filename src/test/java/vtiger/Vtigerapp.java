...
public class Vtigerapp {
	...
	public static void main(String[] args) {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//input[@name='user_name']"))).sendKeys("admin");
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//input[@name='user_password']"))).sendKeys("admin");
